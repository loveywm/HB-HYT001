...
//#define	 Set_LEDK	  	 GPIO_SetBits (GPIOC, GPIO_Pin_6)
#define	 Set_LEDK	  	 GPIO_ResetBits (GPIOE, GPIO_Pin_0)

#define	 Set_CS	  		 GPIO_SetBits (GPIOE, GPIO_Pin_3)
#define	 Reset_CS	  	 GPIO_ResetBits  (GPIOE, GPIO_Pin_3)

#define	 SetR_S	  		 GPIO_SetBits (GPIOE, GPIO_Pin_2)
#define	 Reset_R_S	  	 GPIO_ResetBits  (GPIOE, GPIO_Pin_2)

#define	 Set_RES	  	 GPIO_SetBits (GPIOE, GPIO_Pin_1)
#define	 Reset_RES	  	 GPIO_ResetBits  (GPIOE, GPIO_Pin_1)

#define	 Set_SCK  		 GPIO_SetBits (GPIOE, GPIO_Pin_4)
#define	 Reset_SCK	  	 GPIO_ResetBits  (GPIOE, GPIO_Pin_4)

#define	 Set_SDA 		 GPIO_SetBits (GPIOE, GPIO_Pin_5)
#define	 Reset_SDA	  	 GPIO_ResetBits  (GPIOE, GPIO_Pin_5)
